...
-- =============================================
-- DROP TABLE EFFECTIFS_APPRENANTS
-- DROP TABLE DIMENSION_APPRENANT
...
INSERT INTO TYPE_ACCOMPAGNEMENT
VALUES (255, 'indeterminé', 255)
-- =============================================
-- TABLE EFFECTIFS_APPRENANTS SIMPLIFIÉE
-- =============================================
CREATE TABLE EFFECTIFS_APPRENANTS (
    CODE_EFFECTIFS_APPRENANTS AS 
    CONVERT(
        BINARY(32),
        HASHBYTES(
            'SHA2_256',
