...
CREATE TABLE DIMENSION_PROGRAMMES (
    ...
    CODE_TYPE_INDICATEURS           INT NOT NULL DEFAULT 255,
    ...
    CONSTRAINT FK_DIM_PROG_TYPE_INDICATEUR FOREIGN KEY (CODE_TYPE_INDICATEURS) 
...
INSERT INTO DIMENSION_PROGRAMMES (
    CODE_CENTRE_DELEGATION, CODE_TYPE_ANNEE, CODE_TYPE_INDICATEURS,
...
WHERE NOT EXISTS (
    ...
    WHERE d.CODE_CENTRE_DELEGATION = s.CODE_CENTRE_DELEGATION
      ...
      AND ISNULL(d.CODE_TYPE_INDICATEURS, 255) = ti.CODE_TYPE_INDICATEURS
...
CROSS APPLY (
    ...
    WHERE CODE_CENTRE_DELEGATION = s.CODE_CENTRE_DELEGATION
      ...
      AND ISNULL(CODE_TYPE_INDICATEURS, 255) = ti.CODE_TYPE_INDICATEURS
